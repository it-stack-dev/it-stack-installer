...
# Create 30 lab issues (6 labs x 5 modules) for Phase 2 repos.
#
# Prerequisites:
#   - gh auth login completed
#   - Phase 2 repos exist (run create-phase2-modules.ps1 first)
#   - Labels applied  (run apply-labels.ps1 first)
#   - Milestones set  (run create-milestones.ps1 first)
#
# Usage:
#   powershell -ExecutionPolicy Bypass -File scripts/github/add-phase2-issues.ps1
#   powershell -ExecutionPolicy Bypass -File scripts/github/add-phase2-issues.ps1 -Module nextcloud
...
$modules = @(
  @{ name = "nextcloud";  num = "06"; cat = "collaboration";  phase = "2"; milestone = "Phase 2: Collaboration" },
  @{ name = "mattermost"; num = "07"; cat = "collaboration";  phase = "2"; milestone = "Phase 2: Collaboration" },
  @{ name = "jitsi";      num = "08"; cat = "collaboration";  phase = "2"; milestone = "Phase 2: Collaboration" },
  @{ name = "iredmail";   num = "09"; cat = "communications"; phase = "2"; milestone = "Phase 2: Collaboration" },
  @{ name = "zammad";     num = "11"; cat = "communications"; phase = "2"; milestone = "Phase 2: Collaboration" }
)
